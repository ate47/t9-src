...
function function_ab0ea13b()
{
	...
	while(true)
	{
		if(!is_true(zm_tungsten::function_835bb4a7()) && !is_true(b_on))
		{
			b_on = 1;
			s_button.var_c9b734f5 show();
			s_button.var_c36e3eb9 util::delay(0.5, "death", &hide);
		}
		else if(is_true(zm_tungsten::function_835bb4a7()) && is_true(b_on))
		{
			b_on = 0;
...
function function_bb065751(player)
{
	if(isplayer(player))
	{
		if(!level flag::get(#"hash_1a68e69eb576f35b") && !is_true(zm_tungsten::function_835bb4a7()) && !player isfiring() && !player isreloading() && player getstance() === "stand")
		{
...
function function_d1ac9156()
{
	...
	ai_abom = zombie_utility::spawn_zombie(level.var_3ec2f5f5, "abom", var_507cd99f, level.round_number);
	wait(0.1);
...
function function_d4808171(var_3128fb28)
{
	...
	ai_abomination = zombie_utility::spawn_zombie(level.var_3ec2f5f5, "abom", s_spot, level.round_number);
	wait(0.1);
...
function function_756178a(b_skipped)
{
	...
	foreach(e_player in getplayers())
	{
		level.var_9b6e1cc9 namespace_6783631d::set_is_title_card_02(e_player, 1);
	...
	foreach(e_player in getplayers())
	{
		level.var_9b6e1cc9 namespace_6783631d::set_is_title_card_02(e_player, 0);
		if(!level.var_9b6e1cc9 namespace_6783631d::is_open(e_player))
		{
			level.var_9b6e1cc9 namespace_6783631d::open(e_player);
		}
