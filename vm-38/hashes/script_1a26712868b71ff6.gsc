...
function function_3d5eabf(str_shot)
{
	...
	s_earthquake = {#n_duration:4, #n_end:0.4, #n_start:0, #radius:9999, #origin:level.var_75a7d6.s_boss.origin};
...
/*
	...
	Flags: None
*/
function function_fcfae7e2(str_ai, var_41ca011b)
{
	if(!isdefined(var_41ca011b))
	{
		var_41ca011b = 0;
	...
	if(level.var_75a7d6.var_cd0c8367.size < var_b849ca6e)
	{
		...
		if(level.var_75a7d6.var_e97bb91a.size < var_48857b80)
		{
			if(math::cointoss(5))
			{
				...
				if(!isdefined(str_flag) || !level.var_75a7d6 flag::get(str_flag))
				{
					...
					{
						s_spawn = function_fcfae7e2(#"abom", var_41ca011b);
						if(isstruct(s_spawn))
						{
							return {#s_spawn:s_spawn, #hash_abd5166d:#"abom"};
						}
					}
				}
			}
		...
		if(math::cointoss(0))
		{
			...
			if(!isdefined(str_flag) || !level.var_75a7d6 flag::get(str_flag))
			{
				...
				{
					s_spawn = function_fcfae7e2(#"tempest", var_41ca011b);
					if(isstruct(s_spawn))
					{
						return {#s_spawn:s_spawn, #hash_abd5166d:#"tempest"};
					}
				}
			}
		}
		if(math::cointoss(5))
		{
			...
			if(!isdefined(str_flag) || !level.var_75a7d6 flag::get(str_flag))
			{
				...
				{
					s_spawn = function_fcfae7e2(#"tormentor", var_41ca011b);
					if(isstruct(s_spawn))
					{
						return {#s_spawn:s_spawn, #hash_abd5166d:#"tormentor"};
					}
				}
			}
		}
