...
function function_30f8cfb4(satellite, zone_index, var_14a22ccd)
{
	...
	zm_sq::objective_set(#"hash_1598ff25b76743dd", var_abc3ef9, undefined, undefined, #"hash_8602209567f541c", undefined, &zm_gold_util::function_13ebb331, "vol_player_in_firebase");
	zm_sq::function_3029d343(#"hash_8602209567f541c", var_abc3ef9);
	zm_sq::objective_set(#"hash_68f4e9062d28524d", var_abc3ef9, undefined, var_9bb2940e, #"hash_3e7926c5aefe4406", undefined, &zm_gold_util::function_13ebb331, "vol_player_in_firebase");
	while(true)
	{
		result = undefined;
...
function function_49401276(var_abc3ef9)
{
	...
	while(self.var_94d080b > 0)
	{
		for(i = 0; i < 2; i++)
		{
			...
			zm_sq::function_aee0b4b4(var_ff8e0f2d, var_abc3ef9);
			waitframe(1);
			zm_sq::function_3029d343(var_cc3dc062, var_abc3ef9);
			wait(0.5);
		}
		self.var_94d080b--;
	}
...
function function_bc369205(var_14a22ccd, var_17f8efd5, var_d219813c)
{
	...
	if(!var_17f8efd5)
	{
		...
		foreach(e_player in getplayers())
		{
			...
			level.var_7dbadc8c namespace_72133e5::set_hasCharge(e_player, var_819b2764);
			level.var_7dbadc8c namespace_72133e5::set_hasDamage(e_player, var_7780c6f3);
			level.var_7dbadc8c namespace_72133e5::set_hasOrda(e_player, var_a79c7394);
			level.var_7dbadc8c namespace_72133e5::set_damagePct(e_player, 0.025);
			if(var_819b2764 >= 1)
			{
				level.var_7dbadc8c namespace_72133e5::set_chargePct(e_player, 0.025);
			}
...
function sndonoverride_eye_(var_c8d0baba, var_cfcfe495, var_a80d5874)
{
	...
	foreach(e_player in getplayers())
	{
		if(level.var_7dbadc8c namespace_72133e5::is_open(e_player))
		{
			...
			{
				level.var_7dbadc8c namespace_72133e5::set_damagePct(e_player, progress);
				continue;
			}
			level.var_7dbadc8c namespace_72133e5::set_chargePct(e_player, progress);
		}
	}
}
...
function function_21a9e71b(success, var_14a22ccd, var_d219813c)
{
	...
	foreach(e_player in getplayers())
	{
		if(isdefined(level.var_7dbadc8c) && level.var_7dbadc8c namespace_72133e5::is_open(e_player))
		{
			...
			level.var_7dbadc8c namespace_72133e5::set_hasOrda(e_player, 0);
		}
	}
