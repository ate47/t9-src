...
{
	var_8670e6a3 = get_mission_data(#"persistent", missionname);
...
/*
	...
	Flags: Linked
*/
function get_mission_data(dataname, missionname)
{
...
/*
	...
	Flags: Linked
*/
function clear_mission_data(dataname, missionname)
{
	if(!isdefined(missionname))
	{
		missionname = get_mission_name();
